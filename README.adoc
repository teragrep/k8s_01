...
And start the k8s_01 image with for example the following arguments.
...
"args": [
  "-c",
  "cd /opt/teragrep/k8s_01 || exit 1; java -Dlog4j2.configurationFile=file:etc/log4j2.xml -jar lib/k8s_01.jar;"
]
----
